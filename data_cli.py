...
# val_file_name = "data/TACE2_HZF_81.csv"
...
class MyDataset(data.Dataset):
    def __init__(self, split='train', data_dir=None, transform=None, ratio=0.8):
        ...
        if self.split == 'train':
            ...
            cli_patient_name = train_set_name
            cli_patient_data = train_set_data
            # with open('data/test_set_cnn.csv', 'w') as f_test: f_test.write('patient_name, label \n')
            # with open('data/test_set_cnn.csv', 'a') as f_test:
            ...
            # with open('data/val_set_name198.csv', 'w') as f_val: f_val.write('patient_name, label \n')
            # with open('data/val_set_name198.csv', 'a') as f_val:
            # with open('data/val_HZF94_name.csv', 'w') as f_val: f_val.write('patient_name, label \n')
            # with open('data/val_HZF94_name.csv', 'a') as f_val:
